...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($course_id)) {
        ...
        $par3_count = $_POST['par3-count'];

        $sql = "INSERT INTO Courses (course_name, tee_color, hole1_yardage, hole2_yardage, hole3_yardage, hole4_yardage, hole5_yardage, hole6_yardage, hole7_yardage, hole8_yardage, hole9_yardage, hole10_yardage, hole11_yardage, hole12_yardage, hole13_yardage, hole14_yardage, hole15_yardage, hole16_yardage, hole17_yardage, hole18_yardage, total_yardage, hole1_par, hole2_par, hole3_par, hole4_par, hole5_par, hole6_par, hole7_par, hole8_par, hole9_par, front9_par, hole10_par, hole11_par, hole12_par, hole13_par, hole14_par, hole15_par, hole16_par, hole17_par, hole18_par, back9_par, total_par, par3_count) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $stmt->bind_param(
            "ssiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii",
            $course_name,
            $tee_color,
            $_POST['yard1'],
            $_POST['yard2'],
